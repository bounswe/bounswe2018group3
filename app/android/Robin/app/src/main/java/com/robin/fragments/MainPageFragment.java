...
import com.robin.R;
import com.robin.adapters.EventAdapter;
import com.robin.models.Event;
import com.robin.models.Image;
...
public class MainPageFragment extends Fragment {
    ...
    private void getEvents() {
        events.clear();
        String[] testimages = {"https://d36tnp772eyphs.cloudfront.net/blogs/1/2015/05/ephesus-ruins-940x588.jpg",
        "https://s3.amazonaws.com/homelink/media/images/listingsrescale/58354b5650c7d_610_385.jpg",
        ...
        "https://i.ytimg.com/vi/WKQdVm5MLWU/maxresdefault.jpg",
        ...
        for (String i: testimages) {
            ...
            event.setEventInfo("Event Description");
